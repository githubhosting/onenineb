    ...
    >
      <div className={`flex-1 ${styles.flexStart} flex-col`}>
        ...
        <div className="flex flex-row justify-between items-center w-full relative">
          <h1 className="flex-1 font-poppins font-semibold lg:text-[65px] sm:text-[55px] text-[37px] text-white sm:leading-[100.8px] leading-[75px]">
            The Future of <br />
            <span className="primary_text_shade break-all">Data Science </span>
            <br />
            is No Code
          </h1>
        ...
        <p
          className={`${styles.paragraph} max-w-[80%] md:max-w-[80%] lg:max-w-[85%] mt-5`}
        >
          Build Data Driven Workforce using No Code Data Intelligence Platform
          {/* Invest now, you'll never regret it. Biteezy, Secured and easy to use.
          THe Most secured currency ever to start.. */}
        </p>
      ...
      <div className={`flex-1 flex ${styles.flexEnd} relative`}>
        <img
          src={bitcoin}
          alt="bitocin"
          className="h-[280px] ss:h-[450px] object-contain rounded-lg"
        />
